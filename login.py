...
# Directories for storing account data  
ensure_dir('accounts')  
...
password_input = os.getenv("INSTAGRAM_PASSWORD")  

# Ensure that username and password are loaded  
if not username or not password_input:  
    print("Please ensure that your Instagram credentials are set in the .env file.")  
    exit(1)  
...
session_data = {  
    ...
    "num_replies": 5,  # Sample value; adjust as needed  
    "messages": ["Message 1", "Message 2", "Message 3"],  # Sample value; adjust as needed  
}  
